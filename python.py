...
def abrir_termometro():
    ...
    def actualizar_gauge():
        ...
        ax_g.text(np.pi/2, 1.2, f"{media:.1f} °C",
...
for c in "CDE":
    tk.Button(frame_menu, text=f"{c} - Opción {c}", font=("Arial", 14), width=25, bg="#2e8b57", fg="white",
...
boton_termometro = tk.Button(frame_monitor, text="Ver termómetro",
